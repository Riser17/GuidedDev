namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalculateMaximumRealtyPriceProcessUsrRealtyFreedomUI1MethodsWrapper

	/// <exclude/>
	public class UsrCalculateMaximumRealtyPriceProcessUsrRealtyFreedomUI1MethodsWrapper : ProcessModel
	{

		public UsrCalculateMaximumRealtyPriceProcessUsrRealtyFreedomUI1MethodsWrapper(Process process)
			: base(process) {
